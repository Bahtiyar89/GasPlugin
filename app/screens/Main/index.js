...
import { markers, mapDarkStyle, mapStandardStyle } from './markers';
  ...
  return (
    <Fragment>
      <Appbar.Header style={MainStyle.appBarThreeItem}>
        <Image
          source={require('../../assets/logo.png')} //Change your icon image here
          style={{ height: 25, width: 25 }}
        />
        <Text>Gas Plugin</Text>
        <View style={styles.searchBox0}>
          ...
          />
          <MaterialCommunityIcons name="text-box-search" size={20} />
        </View>
        <Image
          source={require('../../assets/list.png')} //Change your icon image here
          style={{ height: 25, width: 25 }}
        />
      </Appbar.Header>
